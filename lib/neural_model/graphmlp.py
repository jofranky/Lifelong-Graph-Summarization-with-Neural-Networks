"""
graphmlp.py: GraphMLP model https://github.com/yanghu819/Graph-MLP adapted to pytorch_geometric
"""
...
class GMLP(nn.Module):
    def __init__(self, nfeat, nclass, nhid, dropout,device):
    ...
    def forward(self, data):
        ...
        if self.training:
            x_dis = get_feature_dis(Z, self.device)
